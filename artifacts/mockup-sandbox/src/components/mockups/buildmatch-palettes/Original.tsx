import { Star, MapPin, RotateCcw, X, Check, Zap } from "lucide-react";
    ...
    <div className="flex flex-col h-screen w-full font-['Inter']" style={{ backgroundColor: P.bg, color: P.fg }}>
      ...
      <div className="flex-1 px-4 pt-1 pb-0 relative">
        ...
        <div className="relative h-full rounded-3xl overflow-hidden" style={{ backgroundColor: P.card, border: `1px solid ${P.border}` }}>
          {/* Photo area */}
          <div className="h-52 relative overflow-hidden" style={{ background: `linear-gradient(135deg, #2a2010 0%, #1a1206 100%)` }}>
          ...
          <div className="px-5 py-4 flex flex-col gap-3">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold" style={{ backgroundColor: P.elevated }}>CSCS Card</span>
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold" style={{ backgroundColor: P.elevated }}>ECS Gold</span>
            </div>

            <div className="flex items-center gap-1.5">
              <Star size={13} fill={P.primary} style={{ color: P.primary }} />
