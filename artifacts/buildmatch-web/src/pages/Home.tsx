    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden selection:bg-accent selection:text-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-primary flex items-center justify-center transform -skew-x-12 shadow-[0_0_20px_rgba(59,130,246,0.3)]">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-bold tracking-wide uppercase text-muted-foreground">
            ...
            <a href="#trades" className="hover:text-white transition-colors">For Trades</a>
            <a href="#builders" className="hover:text-white transition-colors">For Builders</a>
            <a href="#pricing" className="hover:text-white transition-colors">Pricing</a>
          </div>
          
          <div className="hidden md:flex items-center gap-4">
            <Button variant="ghost" className="text-white hover:bg-white/10 hover:text-white rounded-none font-bold uppercase tracking-wider">Log In</Button>
            <Button className="bg-accent hover:bg-accent/90 text-white rounded-none font-black uppercase tracking-wider shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transition-all">Get the App</Button>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-6 text-xl font-black uppercase tracking-wider">
              <a href="#how-it-works" onClick={() => setIsMobileMenuOpen(false)} className="border-b border-white/10 pb-4">How it works</a>
              <a href="#trades" onClick={() => setIsMobileMenuOpen(false)} className="border-b border-white/10 pb-4">For Trades</a>
              <a href="#builders" onClick={() => setIsMobileMenuOpen(false)} className="border-b border-white/10 pb-4">For Builders</a>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 min-h-screen flex items-center">
        <div className="absolute inset-0 z-0">
          <img src="/images/hero-bg.png" alt="Construction worker" className="w-full h-full object-cover opacity-40 mix-blend-overlay" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#060D1F] via-[#060D1F]/90 to-transparent"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#060D1F] via-transparent to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center w-full">
          <div>
            ...
            <FadeIn delay={0.4} className="mt-12 flex items-center gap-4 text-sm font-bold text-muted-foreground uppercase tracking-wider border-t border-white/10 pt-8">
              <div className="flex -space-x-3">
                ...
                <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center border-2 border-background text-xs text-white">4k+</div>
              </div>
              <p>Trusted by <span className="text-white">4,000+</span> trades across London</p>
            </FadeIn>
          </div>

          <div className="relative h-[600px] hidden lg:flex items-center justify-center">
            <FadeIn delay={0.4} direction="left" className="relative w-full max-w-[340px] aspect-[9/19] bg-[#060D1F] rounded-[3rem] border-[12px] border-secondary shadow-2xl overflow-hidden ring-1 ring-white/10">
              {/* Phone Notch */}
              <div className="absolute top-0 inset-x-0 h-6 bg-secondary rounded-b-3xl mx-auto w-1/3 z-20"></div>
              
              {/* App UI */}
              <div className="absolute inset-0 flex flex-col p-4 pt-10">
                <div className="flex justify-between items-center mb-4">
                  <div className="text-xl font-black tracking-tighter">BM.</div>
                ...
                <div className="relative rounded-2xl overflow-hidden flex-1 bg-muted shadow-lg border border-white/10">
                  <img src="/images/worker-1.png" alt="Worker profile" className="w-full h-full object-cover" />
                  
                  <div className="absolute top-4 right-4 bg-background/80 backdrop-blur border border-white/10 rounded px-2 py-1 flex items-center gap-1">
                ...
                <div className="flex gap-4 justify-center mt-6 mb-4">
                  <button className="w-16 h-16 rounded-full bg-secondary border border-white/10 text-white/50 flex items-center justify-center shadow-lg hover:bg-destructive hover:text-white transition-all transform hover:scale-105">
                    <X className="w-8 h-8" />
                  </button>
                  <button className="w-16 h-16 rounded-full bg-primary border-none text-white flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:bg-primary/90 transition-all transform hover:scale-105">
            ...
            {/* Floating Elements */}
            <FadeIn delay={0.6} direction="right" className="absolute top-1/4 -right-12 bg-secondary p-4 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] max-w-[220px] transform rotate-3">
            ...
            <FadeIn delay={0.7} direction="left" className="absolute bottom-1/3 -left-16 bg-secondary p-4 border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform -rotate-3">
              <div className="flex items-center gap-3">
      ...
      <div className="border-y border-white/10 bg-secondary/50 py-4 flex overflow-hidden whitespace-nowrap">
      ...
      <section id="how-it-works" className="py-24 md:py-32 px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="hidden md:block absolute top-24 left-[10%] right-[10%] h-px bg-white/10 -z-10"></div>
            
            <FadeIn delay={0.1}>
              <div className="bg-secondary/30 border border-white/5 p-8 text-center h-full hover:bg-secondary/50 transition-colors group">
                <div className="w-20 h-20 mx-auto bg-background border border-white/10 flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-secondary/30 border border-white/5 p-8 text-center h-full hover:bg-secondary/50 transition-colors group relative">
                <div className="w-20 h-20 mx-auto bg-background border border-white/10 flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            ...
            <FadeIn delay={0.3}>
              <div className="bg-secondary/30 border border-white/5 p-8 text-center h-full hover:bg-secondary/50 transition-colors group">
                <div className="w-20 h-20 mx-auto bg-background border border-white/10 flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                  ...
                  <Hammer className="w-8 h-8 text-white absolute" />
                </div>
      ...
      {/* For Trades Section */}
      <section id="trades" className="py-24 md:py-32 px-6 bg-secondary relative border-y border-white/5">
            ...
            <div className="order-2 md:order-1">
              <FadeIn>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-background border border-white/10 p-6 transform hover:-translate-y-1 transition-transform">
                  ...
                  <div className="bg-background border border-white/10 p-6 sm:mt-12 transform hover:-translate-y-1 transition-transform">
            ...
            <div className="order-1 md:order-2">
              <FadeIn>
                ...
                <div className="flex flex-col gap-6 mb-10">
                  <div className="flex items-center gap-4 bg-background border border-white/5 p-4">
                    <div className="w-12 h-12 flex-shrink-0 bg-secondary flex items-center justify-center border border-white/10">
                ...
                <Button className="bg-white hover:bg-white/90 text-background rounded-none h-14 px-8 text-lg font-black uppercase tracking-wider w-full sm:w-auto">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <FadeIn>
              ...
              <div className="space-y-8 relative before:absolute before:inset-0 before:ml-[1.15rem] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
                
                <div className="relative flex items-start gap-6">
                  <div className="w-10 h-10 rounded-full bg-background border border-accent flex items-center justify-center flex-shrink-0 relative z-10 shadow-[0_0_15px_rgba(6,182,212,0.3)]">
                  ...
                  <div className="pt-2 pb-6">
                    ...
                    <p className="text-muted-foreground font-medium bg-secondary border border-white/5 p-4 font-mono text-sm">
                ...
                <div className="relative flex items-start gap-6">
                  <div className="w-10 h-10 rounded-full bg-background border border-primary flex items-center justify-center flex-shrink-0 relative z-10 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                ...
                <div className="relative flex items-start gap-6">
                  <div className="w-10 h-10 rounded-full bg-background border border-white flex items-center justify-center flex-shrink-0 relative z-10 shadow-[0_0_15px_rgba(255,255,255,0.2)]">
          ...
          <div className="relative">
            <FadeIn direction="left">
              <div className="relative aspect-[4/5] bg-secondary border border-white/10 p-6 overflow-hidden">
                <img src="/images/manager-1.png" alt="Site Manager" className="absolute inset-0 w-full h-full object-cover opacity-60 mix-blend-luminosity" />
                <div className="absolute inset-0 bg-gradient-to-t from-background via-background/60 to-transparent"></div>
                
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div className="self-end bg-black/60 backdrop-blur-md border border-white/10 px-4 py-2 flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                    <span className="font-bold text-xs uppercase tracking-widest text-white">Project: Elephant & Castle</span>
                  </div>

                  <div>
                    <h3 className="text-3xl font-black uppercase tracking-tighter mb-6 text-white text-shadow-sm">Daily Site Dashboard</h3>
                    
                    <div className="space-y-3">
                      <div className="bg-black/60 backdrop-blur border border-white/10 p-4 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-primary/20 flex items-center justify-center"><Zap className="w-4 h-4 text-primary" /></div>
                          <div>
                            <div className="font-bold text-white text-sm uppercase">Electricians</div>
                            <div className="text-xs text-muted-foreground">3 needed • 3 filled</div>
                          </div>
                        </div>
                        <Badge className="bg-green-500/20 text-green-400 border-none rounded-sm">STAFFED</Badge>
                      </div>

                      <div className="bg-black/60 backdrop-blur border border-accent/30 p-4 flex justify-between items-center transform scale-105 shadow-[0_0_20px_rgba(6,182,212,0.15)] relative">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-bold text-white text-sm uppercase">Dryliners</div>
                      ...
                      <div className="bg-black/60 backdrop-blur border border-white/10 p-4 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-white/10 flex items-center justify-center"><HardHat className="w-4 h-4 text-white" /></div>
                          <div>
                            <div className="font-bold text-white text-sm uppercase">Labourers</div>
      ...
      {/* Testimonials */}
      <section className="py-24 px-6 border-y border-white/5 bg-[#0A1229]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <FadeIn>
              <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter">Word on the <span className="text-white">Site.</span></h2>
            </FadeIn>
            <FadeIn delay={0.1}>
              <div className="flex gap-2">
                <div className="w-12 h-12 border border-white/10 flex items-center justify-center hover:bg-white/5 cursor-pointer transition-colors"><ChevronLeft className="w-6 h-6 text-white" /></div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <FadeIn delay={0.2}>
              <Card className="bg-background border-white/10 rounded-none p-8 hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-center gap-4 border-t border-white/10 pt-6">
                  <div className="w-12 h-12 bg-secondary flex items-center justify-center text-lg font-black uppercase border border-white/10">MB</div>
                  <div>
                    <div className="font-bold text-white uppercase tracking-wider">Mark B.</div>
            ...
            <FadeIn delay={0.3}>
              <Card className="bg-background border-white/10 rounded-none p-8 hover:border-accent/50 transition-colors">
                <div className="flex gap-1 mb-6">
                  {[1,2,3,4,5].map(i => <Star key={i} className="w-5 h-5 fill-accent text-accent" />)}
                </div>
                <p className="text-xl font-medium text-white/90 mb-8 leading-relaxed">
                ...
                <div className="flex items-center gap-4 border-t border-white/10 pt-6">
                  ...
                  <div>
                    <div className="font-bold text-white uppercase tracking-wider">Tom D.</div>
      ...
      <section id="pricing" className="py-24 md:py-32 px-6 bg-background relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-0 relative z-10">
          <FadeIn direction="right" delay={0.1}>
            <div className="bg-secondary border border-white/10 p-10 h-full flex flex-col relative z-0 md:pr-16">
              ...
              <ul className="space-y-5 mb-10 flex-1 text-white/80 font-medium">
              ...
              <Button variant="outline" className="w-full bg-transparent hover:bg-white/5 text-white rounded-none border border-white/20 h-14 font-black uppercase tracking-wider text-lg">Create Profile</Button>
            </div>
          </FadeIn>
          ...
          <FadeIn direction="left" delay={0.2}>
            <div className="bg-primary p-10 h-full flex flex-col relative z-10 shadow-[0_0_50px_rgba(59,130,246,0.3)] md:-ml-8 md:my-[-20px]">
              <div className="absolute top-0 right-0 bg-background text-white text-xs font-black uppercase tracking-widest px-4 py-2 border-b border-l border-white/10">Industry Standard</div>
              ...
              <Button className="w-full bg-background hover:bg-background/90 text-white rounded-none h-14 font-black uppercase tracking-wider text-lg shadow-xl">Start Free Trial</Button>
            </div>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <FadeIn>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="bg-background hover:bg-[#0A1229] text-white rounded-none h-16 px-10 text-xl font-black uppercase tracking-wider shadow-xl transition-transform hover:scale-105">
                <Apple className="w-6 h-6 mr-3 mb-1" />
                App Store
              </Button>
      ...
      <footer className="bg-background pt-20 pb-10 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            <h4 className="font-black text-white uppercase tracking-wider mb-6">Company</h4>
            <ul className="space-y-4 text-sm font-medium text-muted-foreground">
          ...
          <div>
            <h4 className="font-black text-white uppercase tracking-wider mb-6">Legal</h4>
            <ul className="space-y-4 text-sm font-medium text-muted-foreground">
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            {/* Social mock links */}
            <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary transition-colors cursor-pointer border border-white/10">
