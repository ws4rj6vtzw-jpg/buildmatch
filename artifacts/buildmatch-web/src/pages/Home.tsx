      ...
      <footer className="bg-background pt-20 pb-10 px-6">
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-border text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3">
            ...
            <a href="#" className="flex items-center gap-2 bg-black text-white rounded-xl px-4 py-2 hover:opacity-80 transition-opacity cursor-pointer" style={{minWidth: 140}}>
              <svg viewBox="0 0 814 1000" className="w-6 h-6 flex-shrink-0" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Google Play badge */}
            <a href="#" className="flex items-center gap-2 bg-black text-white rounded-xl px-4 py-2 hover:opacity-80 transition-opacity cursor-pointer" style={{minWidth: 152}}>
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-[9px] font-medium tracking-wide uppercase">Get it on</span>
